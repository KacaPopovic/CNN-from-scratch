...
class RNN(BaseLayer):
    ...
    @property
    def optimizer(self):
        return self._optimizer_weights, self._optimizer_output

    @optimizer.setter
    def optimizer(self, optimizer):
        self._optimizer_weights = copy.deepcopy(optimizer)
        self._optimizer_output = copy.deepcopy(optimizer)
    ...
    def backward(self, error_tensor):
        ...
        self.fc_output.optimizer = self._optimizer_output
        self.fc_hidden.optimizer = self._optimizer_weights
